...
The task owner selects implementation and verification sessions from
...
4. ASK FOR DECISIONS. Use ask_task_owner for decisions, missing requirements, or blockers that belong to the task owner. The task owner decides how to escalate to the human user.
