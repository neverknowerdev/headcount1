...
func TestNewOrchestratorRegistryOnlyExposesManagementTools(t *testing.T) {
	r := NewOrchestratorRegistry(OrchestratorCallbacks{
		...
		GetSessionLastRunStatus: func(context.Context, int32) (OrchestratorSessionLastRunStatus, error) {
			return OrchestratorSessionLastRunStatus{}, nil
		},
	...
	require.Equal(t, []string{"ask_task_owner", "fork_session", "get_session_last_run_status", "get_sessions", "run_new_session", "stop_session"}, r.Names())
