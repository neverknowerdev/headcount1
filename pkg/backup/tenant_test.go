...
func TestTenantExportImportRoundTrip(t *testing.T) {
	...
	task := db.Task{CompanyID: comp.ID, ProjectID: &proj.ID, SprintID: sprint.ID, AgentID: &agent.ID, Title: "root", Status: "in_progress", Priority: "Normal"}
	...
	otherTask := db.Task{CompanyID: otherComp.ID, SprintID: otherSprint.ID, Title: "other task", Status: "backlog", Priority: "Normal"}
