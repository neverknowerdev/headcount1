...
func (q *LLMProviderRepository) CreateLLMProvider(ctx context.Context, p LLMProvider) (LLMProvider, error) {
	err := q.db.WithContext(ctx).Create(&p).Error
	p.HasApiKey = p.ApiKeyEncrypted != ""
	return p, err
}

func (q *LLMProviderRepository) GetLLMProvider(ctx context.Context, id int32) (LLMProvider, error) {
	var p LLMProvider
...
func (q *LLMProviderRepository) ListLLMProviders(ctx context.Context) ([]LLMProvider, error) {
	var p []LLMProvider
...
func (q *LLMProviderRepository) ListLLMProvidersForUser(ctx context.Context, userID int32) ([]LLMProvider, error) {
	var p []LLMProvider
...
func (q *LLMProviderRepository) DeleteLLMProvider(ctx context.Context, id int32) error {
...
func (q *LLMProviderRepository) EnsureBuiltinLLMProvidersForUser(ctx context.Context, userID int32) error {
	uid := userID
