...
// "nothing to report".
func (q *RefreshTokenRepository) GetSessionAbsoluteExpiry(ctx context.Context, userID int32) (time.Time, error) {
	var rt RefreshToken
...
func (q *RefreshTokenRepository) CreateRefreshToken(ctx context.Context, userID int32, familyID, tokenHash string, absoluteExpiry time.Time) (RefreshToken, error) {
	rt := RefreshToken{
		FamilyID:          familyID,
		TokenHash:         tokenHash,
		UserID:            userID,
...
func (q *RefreshTokenRepository) RotateRefreshToken(ctx context.Context, oldHash, newHash string) (RefreshToken, error) {
...
func (q *RefreshTokenRepository) RevokeRefreshFamily(ctx context.Context, familyID string) error {
...
func (q *RefreshTokenRepository) RevokeRefreshTokensForUser(ctx context.Context, userID int32) error {
...
func (q *RefreshTokenRepository) DeleteExpiredRefreshTokens(ctx context.Context) error {
