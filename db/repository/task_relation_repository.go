...
type TaskRelationRepository struct{ db *gorm.DB }

func NewTaskRelationRepository(db *gorm.DB) *TaskRelationRepository {
	return &TaskRelationRepository{db: db}
}

func (q *TaskRelationRepository) CreateTaskRelation(ctx context.Context, relation TaskRelation) (TaskRelation, error) {
...
func (q *TaskRelationRepository) DeleteTaskRelation(ctx context.Context, relationID int32) error {
...
func (q *TaskRelationRepository) ListTaskRelations(ctx context.Context, taskID int32) ([]TaskRelation, error) {
...
func (q *TaskRelationRepository) ListBlockingDependencies(ctx context.Context, taskID int32) ([]Task, error) {
	var tasks []Task
	err := q.db.WithContext(ctx).
...
func (q *TaskRelationRepository) ListDependentTasks(ctx context.Context, prerequisiteTaskID int32) ([]Task, error) {
	var tasks []Task
	err := q.db.WithContext(ctx).
...
func (q *TaskRelationRepository) CanStartTask(ctx context.Context, taskID int32) (bool, []Task, error) {
...
func (q *TaskRelationRepository) ListTaskRelationSummaries(ctx context.Context, taskIDs []int32) (map[int32]TaskRelationSummary, error) {
